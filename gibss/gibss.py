...
def gibss(X, y, L=5, maxiter=100, tol=1e-3, initfun = None, serfun = None):
    def fit_ser(psi, old_component):
        ...
        return serfun(coef_init, X, y, psi)
    coef_init = initfun(X, y, 0.)
    ...
    for _ in range(L):
        ...
        component = serfun(coef_init, X, y, psi)
